...
export default function AnimatedBarChart({
  ...
  const getColorClasses = () => {
    switch (color) {
      ...
      default:
        return {
          bg: "bg-gradient-to-t from-[#004D61] to-[#007EA7]",

          glow: "shadow-[0_0_15px_rgba(0, 78, 97, 0.793)]",

          border: "border-[#007EA7]",
        };
    }
  };
  ...
  return (
    <div className="w-full" style={{ height }}>
      <div className="flex items-end justify-between h-full gap-2 px-2">
        {data.map((item, index) => {
          const barHeight =
            maxValue > 0 ? (animatedData[index] / maxValue) * (height - 40) : 0;
