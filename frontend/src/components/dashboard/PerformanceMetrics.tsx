    ...
    return (
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {[...Array(2)].map((_, index) => (
          <div
            key={index}
            className="bg-(--color-surface) rounded-lg p-6  animate-pulse"
          >
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
      {metrics.map((metric, index) => {
        ...
        return (
          <div
            key={index}
            className={`bg-(--color-surface) rounded-lg p-6 ${metric.bgGlow}  transition-all duration-300 group border border-(--color-border)`}
          >
