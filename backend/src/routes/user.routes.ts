...
import { updateProfileSchema, changePasswordSchema } from "../validation/user.validate.js";
...
// @access  Private
router.post("/upload-image", upload.single("profileImage"), asyncHandler(uploadProfileImage));
